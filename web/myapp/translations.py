...
field_labels = {
    ...
    'es': {'email': "Correo electrónico:", 'password': "Contraseña:"},
    'uk': {'email': "Електронна пошта:", 'password': "Пароль:"},
...
# Словарь для текстов ссылок
policy_link_texts = {
    'en': 'Instruction, terms, booking conditions, and privacy policy',
    'ru': 'Инструкция, термины, условия бронирования и политика конфиденциальности',
    'es': 'Instrucciones, términos, condiciones de reserva y política de privacidad',
    'fr': 'Instructions, conditions générales de réservation et politique de confidentialité',
    'uk': 'Інструкція, терміни, умови бронювання та політика конфіденційності',
    'pl': 'Instrukcje, warunki rezerwacji i polityka prywatności',
    'de': 'Anleitung, Allgemeine Geschäftsbedingungen und Datenschutzrichtlinie',
    'it': 'Istruzioni, termini, condizioni di prenotazione e politica sulla privacy',
}

# Словарь для URL на разных языках
policy_links = {
    'en': 'https://telegra.ph/Privacy-Policy-09-19-96',
    'ru': 'https://telegra.ph/Politika-konfidencialnosti-09-19-5',
    'es': 'https://telegra.ph/Pol%C3%ADtica-de-privacidad-09-19-8',
    'fr': 'https://telegra.ph/Politique-de-confidentialit%C3%A9-09-19-3',
    'uk': 'https://telegra.ph/Pol%D1%96tika-konf%D1%96denc%D1%96jnost%D1%96-09-19',
    'pl': 'https://telegra.ph/Polityka-prywatno%C5%9Bci-09-19',
    'de': 'https://telegra.ph/Datenschutzrichtlinie-09-19',
    'it': 'https://telegra.ph/Politica-sulla-privacy-09-19',
}
